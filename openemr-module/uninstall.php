<?php
/**
 * Uninstaller for the OpenEMR Notin module.
 *
...
$moduleName = 'openemrNotin';
$formAudioToNote = 'notin';
...
<html>
<head>
    <title>OpenEMR Notin Module Uninstaller</title>
    <style>
...
<body>
    <h1>OpenEMR Notin Module Uninstaller</h1>
<?php
try {
    // Step 1: Remove Background Service
    sqlStatement("DELETE FROM `background_services` WHERE `name` = 'Notin_Polling'");
    ...
    <div class="manual-cleanup">
        ...
        <ol>
            ...
            <li><strong>Module Source Directory:</strong>
                <ul>
                    <li><code>/path/to/openemr/interface/modules/custom_modules/openemrNotin/</code></li>
                </ul>
            </li>
            <li style="color:red;"><strong>IMPORTANT: Do NOT delete the form directories below if you want to keep the notes created by this module.</strong>
                <ul>
                    <li><code>/path/to/openemr/interface/forms/notin/</code></li>
        ...
        <p><strong>Note:</strong> By preserving the form directories and the associated database tables, you will be able to access all notes and forms created by the Notin module even after uninstallation.</p>
    </div>
    <?php
    ...
    error_log("Notin Uninstaller Error: " . $e->getMessage());
}
?>
</body>
</html>
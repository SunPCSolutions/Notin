...
The `Notin` module is designed to adhere to the principles of the HIPAA Privacy Rule.
...
*   **Data-at-Rest Encryption:** Sensitive configuration data, specifically the license and API keys, are encrypted at rest in the `notin_config` database table using strong, industry-standard authenticated encryption (ChaCha20-Poly1305). The master encryption key is securely generated and stored in the database, ensuring it is unique to your OpenEMR instance.
